...
import ListarProduos from '../ListarProdutos'
...
export default function estoque(){
    ...
    const[estoqueGeral]=useState([
        ...
        {id:11,nome:'Raquete de Ping pong',valor:'179,00 R$',fabri:'China',marca:'6 Estrelas',imagem:'/public/lista de produtos/10.png'},
        {id:12,nome:'Camisa de Time',valor:'250,00 R$',fabri:'China',marca:'Brasil',imagem:'/public/lista de produtos/11.png'},
        {id:13,nome:'Shorts Esportivo',valor:'245,00 R$',fabri:'China',marca:'Brasil',imagem:'/public/lista de produtos/12.png'},
        {id:14,nome:'Meias de Futebol',valor:'98,00 R$',fabri:'China',marca:'Finta',imagem:'/public/lista de produtos/13.png'},
        {id:15,nome:'bola de fotebol',valor:'124,00 R$',fabri:'Naki',marca:'Naki',imagem:'/public/lista de produtos/14.png'},
    ...
    return(
        <div>
            <Bow/>
            <Carosel/>
            <ListarProduos Lista={estoqueGeral}/>
            <Footer/>
        </div>
    )
}